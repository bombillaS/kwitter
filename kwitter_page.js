...
document.getElementById("user_name").innerHTML = "HOLA" + user_name + "wazzaaa si tu compañero es insano unete aca  SIUU xd #" + room_name;
...
name_with_tag = "<h4>" + nombre +"<img class='user_tick.png'></h4>";
...
console.log("clicks en like-" + message_id);
